...
const displayFavorites = (favorites) => {
  ...
  for(let i = 0; i < favoriteList.length; i++) {
    $('#favorites').append(`
      <a href="javascript:void(0)"><img src="./assets/subtract.svg"/></a>
      <a href="javascript:void(0)" onclick="getWeatherData(${favoriteList[i]['meta']['data']['id']})">${favoriteList[i]['meta']['data']['id']}</a><br/>
    `);
  }
}
